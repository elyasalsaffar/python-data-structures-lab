...
def manage_students():
    # your code here
    students = ['Elyas', 'Ali', 'Sayed']
    first_student = students[1]
    last_student = students[-1]
    print(f'List of Students: {students}')
    print(f'Second Student: {first_student}')
...
def combine_foods():
    # your code here
    foods = ('Apple', 'Banana', 'Raspberry')
    meal = ''
    for add_meal in foods:
        meal = meal + ' ' + add_meal
    print(meal)
...
def create_awesome_students():
    # your code here
    students = ['Elyas', 'Ali', 'Sayed', 'Mohammed', 'Issam']
    awesome_student = [f'{student} is awesome!' for student  in students]
    print(awesome_student)

# Call the function and print the result
# print('Exercise 6:', create_awesome_students())
# create_awesome_students()
...
def filter_foods_with_a():
    ...
    foods_with_an_a = list(filter(lambda food : 'a' in food, foods))
